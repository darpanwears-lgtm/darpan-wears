        ...
        <Dialog onOpenChange={(isOpen) => !isOpen && setEditingProduct(null)}>
            ...
            {editingProduct && (
                 <DialogContent className="max-w-3xl">
                    ...
                    <ProductForm product={editingProduct} onSuccess={() => {
                        const closeButton = document.querySelector('[data-radix-dialog-close-button]');
                        if (closeButton instanceof HTMLElement) {
                            closeButton.click();
                        }
                        setEditingProduct(null);
                    }} />
                     <DialogClose className="sr-only" data-radix-dialog-close-button />
                </DialogContent>
            )}
        </Dialog>
    );
